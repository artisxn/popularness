    ...
    <main class="py-4">
            <div class="container">
                    ...
                    function showonlyone(thechosenone) {
                        $('div[name|="newboxes"]').each(function (index) {
                            if ($(this).attr("id") == thechosenone) {
                                $(this).show(200);
                                //$(this).attr("src","images/minse.png");
                            } else {
                                $(this).hide(600);
                                // $(this).attr("src","images/addviedo.png");
                ...
                <div id="MiddleWraper">
                    ...
                    <!--MiddleWraperRow Start Here-->
                    <div class="MiddleWraperRow">

                        <div class="row">
                            <div class="col-md-3">
                                <div class="aboutdesignlft">
                                    <div class="aboutdesignmenu">
                                        <h2>CORPORATE</h2>
                                        <div class="menudesign">
                                            <ul>
                                                ...
                                                <li id="careeropen"><a href="{{url('page/career')}}">Careers</a>
                                                </li>
                                        ...
                                        <div class="menudesign">
                                            <ul>
                                                <li><a href="http://www.facebook.com/popularness"
                                                       target="_blank">Facebook</a></li>
                                                <li><a href="http://www.twitter.com/popularness" target="_blank">Twitter</a>
                                                </li>
                                                <li><a href="http://www.simplewebsetup.com/" target="_blank">Site
                                                        Credits</a></li>
                                            </ul>
                                        </div>
