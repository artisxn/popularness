                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="profile-sign text-right">
                            <ul>
                                ...
                                <li><a href="{{url('/')}}"><img src="{{asset('front_assets/images/sign2.png')}}"></a></li>
...
<div id="app">
    <main class="py-4">
        <div class="container">
            <div id="MiddleWraper" style="border: 0px solid gray">
                <div class="row" style="border: 0px solid red">
                    <div class="col-3" style="border: 0px solid red">
                        <div class="row">
                            <div class="col-md-8" style="border: 0px solid green;">
                                <img src="{{env('AWS_S3_URL').env('APP_ENV')}}/user/{{Auth::user()->image}}" alt="AVATER" height="160px" width="160px">
                                <div style="text-align: right">
                                    <h6 class="pageheading_in"><a href="{{route('client-home')}}">Settings</a></h6>
                                    <h6 class="pageheading_in"><a href="{{route('my-play-video')}}">Play List</a></h6>
                                    <h6 class="pageheading_in"><a href="{{route('my-favourite-video')}}">Favourite</a></h6>
                                    @if(Auth::user()->user_type == 2)
                                        <h6 class="pageheading_in"><a href="{{route('video-upload')}}">Upload</a></h6>
                                        <h6 class="pageheading_in"><a href="{{route('client-video')}}">Videos</a></h6>
                                        <h6 class="pageheading_in"><a href="{{route('my-balance')}}">Balance</a></h6>
                                        <h6 class="pageheading_in"><a href="{{route('my-subscription')}}">Subscription</a></h6>
                                    @endif
                                    {{--                                <h6 class="pageheading_in">Following</h6>--}}
                                    {{--                                <h6 class="pageheading_in">Community</h6>--}}
                                    {{--                                <h6 class="pageheading_in">My play list</h6>--}}
                                    {{--                                <h6 class="pageheading_in">My Ratings</h6>--}}
                                    {{--                                <h6 class="pageheading_in">Recently Wached</h6>--}}
                    ...
                    <div class="col-9" style="border: 0px solid red" id="clientApp">
